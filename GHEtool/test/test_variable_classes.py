...
def test_ground_data_equal():
    data = GroundData(110, 6, 3, 10, 0.2, 10, 12)
    data2 = GroundData(110, 6, 3, 10, 0.2, 10, 12)
    assert data == data2


def test_ground_data_unequal():
    data = GroundData(110, 6, 3, 10, 0.2, 10, 12)
    data2 = GroundData(110, 7, 3, 10, 0.2, 10, 12)
    assert data != data2
...
def test_pipe_data_equal():
    data = PipeData(1, 0.015, 0.02, 0.4, 0.05, 0.075, 2)
    data2 = PipeData(1, 0.015, 0.02, 0.4, 0.05, 0.075, 2)
    assert data == data2
...
def test_unequal_cross():
    ...
    data_ground = GroundData(110, 6, 3, 10, 0.2, 10, 12)
